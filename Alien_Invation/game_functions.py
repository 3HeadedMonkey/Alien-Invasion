...
def start_game(ai_settings, screen, stats, sb, play_button, ship,
                aliens, bullets):
    """Clears board and starts the game"""
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # Draw the play button if the game is inanctive
    sb.show_score()
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Remobe any bullets and aliens that have collided.
    ...
    if len(aliens) == 0:
        new_level(ai_settings, screen, stats, sb, ship, aliens, bullets)


def new_level(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Starts new level and increases difficulty"""
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Spacing between each alien is eauql to one alien width
...
def create_alien(ai_settings, screen, aliens,
                alien_number, alien_width, row_number):
    """Create an alien and place it in the row"""
    alien = Alien(ai_settings, screen)
